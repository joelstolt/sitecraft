        ...
        <div className="mx-auto max-w-[1312px]">
          <ScrollReveal>
            <div className="mx-auto mb-16 max-w-2xl text-center md:mb-20">
              ...
              <p className="text-[#888] leading-relaxed">Inga långa möten, inga vaga offerter. Vi bygger, du godkänner, vi lanserar.</p>
            </div>
          </ScrollReveal>
        ...
        <div className="relative z-10 mx-auto max-w-[1312px]">
          <ScrollReveal>
            <div className="mx-auto mb-16 max-w-2xl text-center md:mb-20">
              ...
              <p className="text-[#888] leading-relaxed">Riktiga sajter, byggda åt riktiga företag. Varje projekt levererat på under 24 timmar.</p>
            </div>
          </ScrollReveal>
